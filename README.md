...
例:  `Alipay-10.8.30.8000-npatch.apk` ， 安装后若使用过程遇到在原版程序内没有出现的问题或模块问题，请向 `NPatch` 作者反馈 <br>
由于APKPure隶属虎牙，且有安全问题，为了防止出现问题，已将原先使用APKPure源的程序替换为APKMirror
...
| TikTok | TikTok | APKMirror | latest |
